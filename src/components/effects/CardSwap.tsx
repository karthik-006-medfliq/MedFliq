import React, { Children, cloneElement, forwardRef, isValidElement, useEffect, useMemo, useRef, type ReactNode } from 'react';
...
const CardSwap = ({
  ...
  const config =
    easing === 'elastic'
      ...
      : {
          ease: 'power1.inOut', // softened linear easing
          durDrop: 0.5,
          durMove: 0.5,
          durReturn: 0.5,
          promoteOverlap: 0.45,
