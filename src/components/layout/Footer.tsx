      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          >
            ...
            <p className="text-med-slate text-base leading-relaxed font-medium max-w-[400px]">
              AI-native clinical intelligence designed to support medical decisions, streamline hospital workflows, and power the next generation of smart healthcare infrastructure.
            </p>
          </div>
        ...
        >
          <div className="text-[10px] font-bold text-med-slate uppercase tracking-[0.1em]">
            © 2026 MedFliq Intelligence. Built for Elite Healthcare.
          </div>
